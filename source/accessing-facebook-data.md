...
- You can also import the code straight into your IDE:
  ...
  - IntelliJ IDEA
    - An application ID and secret obtained from registering an application with Facebook.
...
- Download and unzip the source repository for this guide, or clone it using Git: git clone https://github.com/spring-guides/gs-accessing-facebook.git
...
Before you can fetch a user’s data from Facebook, you must specify your application’s ID and secret by setting the spring.social.facebook.appId and spring.social.facebook.appSecretproperties. You can set these via any means supported by Spring Boot, including setting them in an application.properties file:
