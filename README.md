...
| [Messaging with RabbitMQ](https://spring.io/guides/gs/messaging-rabbitmq/) | Learn how to create a simple publish-and-subscribe application with Spring and RabbitMQ. |            |           |
...
| [Securing a Web Application](https://spring.io/guides/gs/securing-web/) | Learn how to protect your web application with Spring Security. | @lexburner | @dyc87112 |
...
| [Managing Transactions](https://spring.io/guides/gs/managing-transactions/) | Learn how to wrap key parts of code with transactions. |            |           |
...
| [Using WebSocket to build an interactive web application](https://spring.io/guides/gs/messaging-stomp-websocket/) | Learn how to the send and receive messages between a browser and the server over a WebSocket |            |           |
...
| 标题                                       | 简介                                       | 译者         | 校对        |
| ---------------------------------------- | ---------------------------------------- | ---------- | --------- |
| [Spring Security Architecture](https://spring.io/guides/topicals/spring-security-architecture/) | Topical guide to Spring Security, how the bits fit together and how they interact with Spring Boot | @lexburner | @dyc87112 |
...
| [Spring Security and Angular JS](https://spring.io/guides/tutorials/spring-security-and-angular-js/) | A tutorial on how to use Spring Security with a single page application with various backend architectures, ranging from a simple single server to an API gateway with OAuth2 authentication. | @lexburner | @dyc87112 |
